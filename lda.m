...
%lda and knn fold 1
[ytrainfold1 ,ytestfold1] = ldaf(crossValidationTrainDatafold1,crossValidationTestDatafold1,Actualtrainfold1);
accuracyfold1 = knn(ytestfold1.', ytrainfold1.',Actualtrainfold1.',Actualfold1.');

[ytrainfold2 ,ytestfold2] = ldaf(crossValidationTrainDatafold2,crossValidationTestDatafold2,Actualtrainfold2);
accuracyfold2 = knn(ytestfold2.', ytrainfold2.',Actualtrainfold2.',Actualfold2.');

[ytrainfold3 ,ytestfold3] = ldaf(crossValidationTrainDatafold3,crossValidationTestDatafold3,Actualtrainfold3);
accuracyfold3 = knn(ytestfold3.', ytrainfold3.',Actualtrainfold3.',Actualfold3.');

[ytrainfold4 ,ytestfold4] = ldaf(crossValidationTrainDatafold4,crossValidationTestDatafold4,Actualtrainfold4);
accuracyfold4 = knn(ytestfold4.', ytrainfold4.',Actualtrainfold4.',Actualfold4.');

[ytrainfold5 ,ytestfold5] = ldaf(crossValidationTrainDatafold5,crossValidationTestDatafold5,Actualtrainfold5);
